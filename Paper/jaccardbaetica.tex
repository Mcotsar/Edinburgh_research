...
Material culture is one of the most frequent indicator of trade in the archaeological record. They allow us to highlight a part of mechanism of production and distribution of goods between different communities \citep{bevan_mediterranean_2014}. 
...
In archaeology, this debate has been widely studied in the last centuries (CITAR). Despite this knowledge the application of new methodology to understand the Roman trade has allowed us to deal with the complexity of Roman Market combined with the archaeological evidence \citep{orengo_seeds_2016,brughmans_roman_2016,coto-sarmiento_maria_bayesian_????}. Specifically, our work pretend to detect economic processes in a microescala focused in a commercial product from a specific province \citep{isaksen_network_2006}. 
