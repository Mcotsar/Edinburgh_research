...
\title{The tracing of trade: exploring the patterns of olive oil production and distribution from Roman \textit{Baetica}}
...
This could be explained such as batch systematic organisation between potters \citep{juanmorostesis}. This work method could have allowed potters to identify batches by stamping amphorae for posterior commercialization. 
...
High production of amphorae had to maintain a specialize system organization to control this production \citep[104]{juanmorostesis}.
...
Data have been analysed and conducted in R program version 3.2.4, using the packages \textit{vegan} \citep{oksanen_vegan_2007}, \textit{ggplot2} \citep{ggplot2:_2016}. Datasets and source code are freely available at https://github.com/Mcotsar/Baetica\_stamps.
