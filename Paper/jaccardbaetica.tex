...
\caption{Histogram with the number of stamps (X axis) and the frequency of workshop (Y axis). The distribution is widely diverse with most workshops have only one stamp}
\label{stamps}
\end{figure} 
