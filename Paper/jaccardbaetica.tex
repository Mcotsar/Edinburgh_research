...
\caption{Histogram with the frequency of the number of stamps per workshop. The distribution is widely diverse with most stamps concentrated in one workshop}
\label{stamps}
\end{figure} 
...
\subsection{Hieralchical clustering}

\maria{que pongo aquí}
