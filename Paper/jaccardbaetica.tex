...
Alternatively, the presence of different stamps in the same workshop could imply some kind of organisation from within the workshop only affecting nearby centres \citep{juanmorostesis}. The stamped amphorae could have allowed potters to organise the differnt production batches for posterior commercialisation\xavi{estos 2 párrafos igual deberían ir a la discusión no? La conclusión debería ser algo más general y aquí estás aún interpretando resultados}.  
