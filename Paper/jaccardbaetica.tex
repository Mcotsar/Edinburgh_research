...
The hypothesis about groups of amphora workshops sharing the same stamps seems not match with the results of analysis. Rather it could be interpreted due to several reason. On the one hand, the use of this amphoric stamps were exclusively running by the owner or family to distinguish the amphora workshop (CITAR). (EXPLICAR)
...
%Neither it seems a group of amphora workshops sharing the same stamps. 
