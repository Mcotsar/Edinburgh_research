...
%Julius Caesar's campaigns in \textit{Gallia} during 1st BC opened the door to the invasion of \textit{Germania} during Augustus rule~\citep{remesal_annona_1986,remesal_baetica_2002}\xavi{no hay un resumen de la conquista similar para Britannia, queda raro}. 
...
%\xavi{lo del océano atlántico está un poco descontextualizado; no sería mejor ponerlo al final de esta sección?}
