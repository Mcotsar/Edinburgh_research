...
The hypothesis about groups of amphora workshops sharing the same stamps seems not match with the results of analysis even though there are shareable stamps in closer workshops. Probably same stamps detected in closer amphora workshop could have being wrongly catalogued twice in different way in spite of belonging to the same place or being closer between each other. 
 

%los que aparecen cerca son porque están cerca o puede haber confusión entre talleres
