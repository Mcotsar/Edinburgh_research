...
The similarity of stamps show a results less significant than Britannia province as it can be seen in the dendrogram (Fig. \ref{germap}). 

\begin{figure}[htp]
	\centering
\includegraphics[width=\linewidth]{figs/dendroger5.pdf}
\caption{Dendrogram obtained by Morisita-Horn algorthm of different sites in Germania. Colours are represented by types of sites divided into military sites (red), civil sites (green) and no specific (grey)}
\label{germap}
\end{figure}
